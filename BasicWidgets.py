...
class CPSFileWidget(CPSWidget):
    ...
    def getFileInfo(self, datastructure):
        ...
        current_name = current_name.replace('∆', 'AE')
        current_name = current_name.replace('Ê', 'ae')
        current_name = current_name.replace('º', 'OE')
        current_name = current_name.replace('Ω', 'oe')
        current_name = current_name.replace('ﬂ', 'ss')
