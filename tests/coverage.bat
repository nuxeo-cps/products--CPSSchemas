...
if not exist cover\NUL mkdir cover
%USEPYTHON% coverage.py -x runalltests.py
%USEPYTHON% coverage.py -r ../*.py ../boxes/*.py
%USEPYTHON% coverage.py -a -d cover ../*.py ../boxes/*.py
