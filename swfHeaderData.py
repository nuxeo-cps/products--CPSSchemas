# $Id$
#
# From CMFFlashMovie 0.3.2
# http://www.zope.org/Members/sergeyv/CMFFlashMovie
#
...
def analyseContent(data, filesize):
    """ Analyzes content of (possible compressed) swf file
        and returns header's data as a dictionary
    """
    if len(data)<=(8+17):
        # NUXEO : Raise a proper exception
        raise TypeError("data too small!")
    ...
    # Version 6 or greater ZLIB compressed flash file
        ...
        # NUXEO : Raise a proper exception
        raise TypeError("This does not appear to be an SWF file!")
